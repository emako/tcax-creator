...
void PySyntaxHighlighter::setup(void)
{
...
void PySyntaxHighlighter::highlightBlock(const QString &a_text)
{
...
void PySyntaxHighlighter::addSyntaxKeywords(const QStringList& a_keywords, const QTextCharFormat& a_format)
{
...
void PySyntaxHighlighter::addSyntaxComment(const ECOMMENT_TYPE& a_type, const QTextCharFormat& a_format)
{
    HighlightingRule rule;
    QString pattern;
...
void PySyntaxHighlighter::addSyntaxFunction(const QTextCharFormat& a_format)
{
    HighlightingRule rule;
...
void PySyntaxHighlighter::addSyntax(const QString& a_pattern, const QTextCharFormat& a_format)
{
    HighlightingRule rule;
...
void PySyntaxHighlighter::clear(void)
{
